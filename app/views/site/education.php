...
<section class="education themegradient education-themegradient" id="partners">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="section-title wow zoomIn">
                <h1>Новини</h1>
                <p>Наші новини за напрямом освіта:</p>
            </div>
            <?php if(count($news)): ?>
                <div id="news-list">
...
$pageOptions = \yii\helpers\Json::encode([
    ...
    'category' => \yii\easyii\components\helpers\CategoryHelper::CATEGORY_EDUCATION
]);
